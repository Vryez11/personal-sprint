...
| 07.09 | - 프로그래머스 Lv3 (파괴되지않는건물) <br/> - 면접을 위한 CS 전공지식노트 독서 <br/> - [단디] 성능 테스트용 서버 구축 <br/> - [스파클링] 2주차 과제 (핵심 유스케이스 5개 작성)                                                      | https://github.com/dandi-swm/algorithm-study <br/> https://github.com/Vryez11/sparkling    |
