...
| 07.10 | - 프로그래머스 Lv3 (보석쇼핑) <br/> - [단디] 히스토리 API 설계 리뷰 <br/> - [단디] CLAUD.md 단어 선택(변수명, 메서드명)을 위한 사전 만들기 <br/> - [단디] 음식 기록 시퀀스 다이어그램 설계 <br/> - [스파클링] 2주차 과제 (사용자 시나리오와 기능 목록의 차이, REST API 기본 원칙, 공개 API와 인증 API를 나누는 기준 조사) <br/> - [스파클링] 2주차 과제 (전체 API 목록표, 주요 API 3개 요청/응답 JSON 예시 작성) |                                                                                            |
