...
| 05.27 | - Java 인프런 강의 (네트워크 - 기본 이론, 프로그램 1)<br/>- Java 노션 정리 (네트워크 - 기본 이론, 프로그램 1)<br/>- 클린 코드 독서<br/>- 코테 1문제                                                                                                                                             | https://github.com/Vryez11/java-play-ground<br/>https://github.com/Vryez11/java-algorithm                                                                                                                              |
| 05.28 | - Java 인프런 강의 (네트워크 - 프로그램 2)<br/>- Java 노션 정리 (네트워크 - 프로그램 2)<br/>- 코테 1문제 <br/>- AI 기술 교육 강의 (Prompt Engineering 1강, 2강, 3강, 4강)                                                                                                                   |https://github.com/Vryez11/java-play-ground<br/>https://github.com/Vryez11/java-algorithm                                                                                                                               |
...
| 06.04 | - 코테 2 문제 <br/>- Java 인프런 강의 (리플렉션, 애노테이션) <br/>- Java 노션 정리 (리플렉션, 애노테이션) <br/> - DB 설계 1편 강의 (설계의 중요성) <br/> - DB 노션 정리 (설계의 중요성) <br/> - AI 기술 교육 강의 (Agentic Workflow 5강, 6강, 7강) <br/> - 클린 코드 독서                                               | https://github.com/Vryez11/java-algorithm <br/>https://github.com/Vryez11/java-play-ground <br/>https://github.com/Vryez11/db-study                                                                                                                            |
| 06.05 | - 코테 1 문제 <br/>- AI 기술 교육 강의 (Agentic Workflow 8강, 9강, 10강 <br/>- Java 인프런 강의 (HTTP 서버 활용) <br/> - Java 노션 정리 (HTTP 서버 활용) <br/> - 클로드코드 특강 <br/>- Spring 입문 (프로젝트 환결설정)                                                                             | https://github.com/Vryez11/java-algorithm <br/>https://github.com/Vryez11/java-play-ground <br/>https://www.notion.so/3768e70ba5ff80ef907bd83237605db0?source=copy_link                                                                                                                                 |
| 06.06 | - Cache 사용 패턴과 Redis/Valkey 특강 <br/>- AI 기술 교육 협업 프로젝트 <br/>- LeetCode 코테 1문제 <br/>- Spring 입문 (웹 개발 기초) <br/> - 클린코드 독서                                                                                                                             | https://github.com/sanghyeon1225/asm-team18-ai-study <br/>https://github.com/Vryez11/java-algorithm                                                                                                                                  |
| 06.07 | - 코테 1 문제                                                                                                                                                                                                                                            | https://github.com/Vryez11/java-algorithm                                                                                                                                   |
