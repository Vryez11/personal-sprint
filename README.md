...
```mermaid
gantt
    title Personal Sprint Timeline
    dateFormat YYYY-MM-DD
    axisFormat %m.%d
    section Sprint 01
    기본기 마스터 :active, s1, 2026-05-26, 2026-05-31
    section Sprint 02
    예정          :s2, after s1, 7d
    section Sprint 03
    예정          :s3, after s2, 7d
...
| #    | 기간                | 목표 (한 줄)  | 결과물        | 회고                                 |
|------|-------------------|-----------|------------|--------------------------------------|
| [01](./sprint-01/) | 2026.05.25 – 05.31 | _기본기 마스터_ | _[스프린트](./sprint-01/)_ | [→](./sprint-01/retrospective.md)    |
| 02   | –                 | –         | –          | –                                    |
| 03   | –                 | –         | –          | –                                    |
