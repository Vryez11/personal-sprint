...
| 09.15 | - CS 면접 (동시성 - Java 메모리 모델) <br/> - 컨텍스트 스위칭 정리 마무리 <br/> - 프로그래머스 Lv2 (피로도) <br/> - 삼성 SDS 자기소개서 제출 <br/> - [단디] 중간 발표 자료 마무리 <br/> - [단디] 백엔드 팀 코드 리뷰 (로그아웃·비밀번호 재설정 시 access token 무효화)                                                 |                                      |
