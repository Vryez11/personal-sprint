...
| 07.23 | - CS 면접 (JVM/GC - JVM 메모리 구조 — 힙·스택·메타스페이스) <br/> - 백엔드 실습 과제 (싱글톤 빈의 공유 상태로 인한 결제 금액 뒤섞임 버그 잡기) <br/> - 프로그래머스 Lv2 (도넛과막대그래프) <br/> - [스파클링] 4주차 과제 (회원가입 API 구현) <br/> - 가상 면접 사례로 배우는 대규모 시스템 설계 기초 1편 공부 | https://github.com/Vryez11/backend-lab                                 |
