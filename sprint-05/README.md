...
| 07.27 | - [단디] Mapper 함수로 생성자 리팩토링 <br/> - [단디] total 구하는 for문 리팩토링 <br/> - [단디] Calculator 클래스 리팩토링 <br/> - [단디] Range클래스를 helper함수 수정 <br/> - CS 면접 (데이터 베이스 - 트랜잭션과 ACID) <br/> - 백엔드 실습 과제 (커넥션을 삼키는 조회수 API — 몇 번 부르면 멈추는 장애를 잡아라)                                                          |                                                                                  |
