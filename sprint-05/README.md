...
| 07.24 | - CS 면접 (자료구조 - 배열 vs 연결리스트) <br/> - 백엔드 실습 과제 (스프링 컨테이너 없이는 죽는 결제 서비스) <br/> - 프로그래머스 Lv3 (여행경로) <br/> - 가상 면접 사례로 배우는 대규모 시스템 설게 기초 1편 공부 - [단디] 초기 Nyummy 서버 아키텍처 설계                                                                                                                   | https://github.com/Vryez11/backend-lab                                                                                 |
